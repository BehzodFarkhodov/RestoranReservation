...
<%--&lt;%&ndash;        <button type="button">Search</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <div class="registration-buttons">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <a href="register" class="registration-button">Register</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <a href="login" class="registration-button">Login</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
<%--</div>--%>
